...
function library:New(Name)
	...
	function tabs.MakeTab(image, currenttab)
		tabcount += 1
	...
	function tabs.MakeButton(name, tab, buttoncount, func)
	...
	function tabs.MakeToggle(name, tab, count, func)
		local toggled = false
	...
	function tabs.MakeSlider(name, min, max, tab, count, func)
		local Ypos = ((count * 55) -50)
